...
int main(int argc, char **argv) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // appears in a window automatically called "Debug"
        // {
        //     static float f = 0.0f;
        ...
        // // 2. Show another simple window, this time using an explicit
        // Begin/End pair if (show_another_window)
        // {
        //     ImGui::SetNextWindowSize(ImVec2(200,100),
        //     ImGuiSetCond_FirstUseEver); ImGui::Begin("Another Window",
        //     &show_another_window); ImGui::Text("Hello"); ImGui::End();
        // }
