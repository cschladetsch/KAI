...
struct ConstMethodBase : MethodBase {
    ...
    void Invoke(const Object &Q, Stack &S) { ConstInvoke(Q, S); }
};
            ...
            struct Returning {
                ...
                struct WithArgs : ConstMethodBase<ReturnType (T::*)() const> {
                    ...
                    void ConstInvoke(const Object &Q, Stack &stack) {
                        ...
                        Pointer<ReturnType> R =
                            Q.GetRegistry()->New<ReturnType>();
                        *R = ((*servant).*method)();
                        stack.Push(R);
                    }
                };
    ...
    struct WithArity<2> {
        ...
        struct Const {
            ...
            struct Returning {
                ...
                struct WithArgs
                    : ConstMethodBase<ReturnType (T::*)(A0, A1) const> {
                    typedef ConstMethodBase<ReturnType (T::*)(A0, A1) const>
                        Parent;
                    WithArgs(typename Parent::MethodType M) : Parent(M) {}
                    void ConstInvoke(const Object &Q, Stack &stack) {
                        Pointer<const T> servant = Q;
        ...
        struct Const<false> {
            ...
            struct Returning {
                template <class A0, class A1, class>
                struct WithArgs
                    : MutatingMethodBase<ReturnType (T::*)(A0, A1)> {
                    typedef MutatingMethodBase<ReturnType (T::*)(A0, A1)>
                        Parent;
                    WithArgs(MethodType M) : Parent(M) {}
                    void Invoke(const Object &Q, Stack &stack) {
                        Pointer<T> servant = Q;
...
template <class T, class R, bool C, class A0 = meta::Null,
          class A1 = meta::Null, class A2 = meta::Null>
struct Method : method_detail::Method<T>::WithArity<
                    meta::Arity<A0, A1, A2>::Value>::Hack<C, R, A0, A1, A2> {
    typedef typename method_detail::Method<T>::WithArity<
        meta::Arity<A0, A1, A2>::Value>::Hack<C, R, A0, A1, A2>
        Parent;
